...
switch ( $action ) {
	...
	case 'retrievepassword':
		...
		login_header( __( 'Lost Password' ), '<p class="message">' . __( 'Please enter your Investec ID or email address. You will receive an email message with instructions on how to reset your password.' ) . '</p>', $errors );
		...
		<form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( network_site_url( 'wp-login.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
			<p>
				<label for="user_login"><?php _e( 'Investec ID' ); ?></label>
